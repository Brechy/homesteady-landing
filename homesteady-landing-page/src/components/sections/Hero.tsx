    ...
    <section className="relative min-h-screen bg-gradient-to-b from-cream-50 to-cream-100 pt-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 md:pt-20">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-gray-500">
              <div className="flex items-center gap-2">
                <WifiOff className="w-4 h-4 text-sage-500" />
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              <div className="w-64 sm:w-72 h-[500px] sm:h-[560px] bg-gray-900 rounded-[3rem] shadow-2xl p-3 animate-float">
                <div className="w-full h-full bg-gradient-to-b from-sage-50 to-cream-100 rounded-[2.5rem] overflow-hidden relative">
                  ...
                  <div className="pt-10 px-4">
                      ...
                      <div className="bg-white rounded-xl p-3 shadow-sm border border-sage-100">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-sage-100 rounded-lg flex items-center justify-center">
                            <Bird className="w-5 h-5 text-sage-600" />
                          </div>
                    ...
                    <div className="mt-4 bg-gradient-to-r from-sage-500 to-sage-600 rounded-xl p-3 text-white">
        ...
        <div className="mt-16 md:mt-24 flex flex-wrap justify-center gap-8 md:gap-16 pb-12 md:pb-20">
          ...
          <div className="text-center">
            <p className="text-3xl md:text-4xl font-serif font-bold text-sage-600">30+</p>
